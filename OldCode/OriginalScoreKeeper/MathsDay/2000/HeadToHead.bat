...
Echo -----------------------------------------------------------------------
C:
cd C:\ScoreKeeper\MATHSDAY\2000
Echo Copying Head to Head Input from DB Directory to System Directory
Copy C:\ScoreKeeper\MATHSDAY\2000\SwissHTHin5.txt "C:\ScoreKeeper\MATHSDAY\2000\data.txt"
Echo Running Java to Determine Head to Head Round 5
"C:\Program Files\JavaSoft\JRE\1.3.0_02\bin\java" Swiss > C:\ScoreKeeper\MATHSDAY\2000\SwissHTHOut5.txt
